  ...
  class MdfeSefazAquav
    ...
    def c_embar=(c_embar)
      ...
      if !c_embar.nil? && c_embar.to_s.length < 1
        fail ArgumentError, 'invalid value for "c_embar", the character length must be great than or equal to 1.'
      end
    ...
    def x_embar=(x_embar)
      ...
      if !x_embar.nil? && x_embar.to_s.length < 1
        fail ArgumentError, 'invalid value for "x_embar", the character length must be great than or equal to 1.'
      end
    ...
    def c_prt_emb=(c_prt_emb)
      ...
      if !c_prt_emb.nil? && c_prt_emb.to_s.length < 1
        fail ArgumentError, 'invalid value for "c_prt_emb", the character length must be great than or equal to 1.'
      end
    ...
    def c_prt_dest=(c_prt_dest)
      ...
      if !c_prt_dest.nil? && c_prt_dest.to_s.length < 1
        fail ArgumentError, 'invalid value for "c_prt_dest", the character length must be great than or equal to 1.'
      end
    ...
    def prt_trans=(prt_trans)
      ...
      if !prt_trans.nil? && prt_trans.to_s.length < 1
        fail ArgumentError, 'invalid value for "prt_trans", the character length must be great than or equal to 1.'
      end
