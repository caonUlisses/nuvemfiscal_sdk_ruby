...
module NuvemFiscalClient
  class NfePedidoEmissao
    attr_accessor :inf_nfe

    attr_accessor :inf_nfe_supl
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NuvemFiscalClient::NfePedidoEmissao` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NuvemFiscalClient::NfePedidoEmissao`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'inf_nfe')
        self.inf_nfe = attributes[:'inf_nfe']
      else
        self.inf_nfe = nil
      end

      if attributes.key?(:'inf_nfe_supl')
        self.inf_nfe_supl = attributes[:'inf_nfe_supl']
      end
    ...
    def list_invalid_properties
      ...
      if @inf_nfe.nil?
        invalid_properties.push('invalid value for "inf_nfe", inf_nfe cannot be nil.')
      end
    ...
    def hash
      [inf_nfe, inf_nfe_supl, ambiente, referencia].hash
    end
