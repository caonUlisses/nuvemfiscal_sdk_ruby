  ...
  class CteSimpSefazComplSimp
    ...
    def self.openapi_types
      {
        ...
        :'x_obs' => :'String',
        :'obs_cont' => :'Array<CteSimpSefazObsContSimp>',
        :'obs_fisco' => :'Array<CteSimpSefazObsFiscoSimp>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NuvemFiscalClient::CteSimpSefazComplSimp` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NuvemFiscalClient::CteSimpSefazComplSimp`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [x_carac_ad, x_carac_ser, fluxo, x_obs, obs_cont, obs_fisco].hash
    end
