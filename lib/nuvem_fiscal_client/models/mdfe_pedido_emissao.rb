...
module NuvemFiscalClient
  class MdfePedidoEmissao
    attr_accessor :inf_mdfe

    attr_accessor :inf_mdfe_supl
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NuvemFiscalClient::MdfePedidoEmissao` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NuvemFiscalClient::MdfePedidoEmissao`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'inf_mdfe')
        self.inf_mdfe = attributes[:'inf_mdfe']
      else
        self.inf_mdfe = nil
      end

      if attributes.key?(:'inf_mdfe_supl')
        self.inf_mdfe_supl = attributes[:'inf_mdfe_supl']
      end
    ...
    def list_invalid_properties
      ...
      if @inf_mdfe.nil?
        invalid_properties.push('invalid value for "inf_mdfe", inf_mdfe cannot be nil.')
      end
    ...
    # @param [Object] inf_mdfe Value to be assigned
    def inf_mdfe=(inf_mdfe)
      if inf_mdfe.nil?
        fail ArgumentError, 'inf_mdfe cannot be nil'
      end
    ...
    def hash
      [inf_mdfe, inf_mdfe_supl, ambiente, referencia].hash
    end
