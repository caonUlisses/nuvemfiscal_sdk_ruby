...
module NuvemFiscalClient
  class NfcomPedidoEmissao
    attr_accessor :inf_nf_com
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NuvemFiscalClient::NfcomPedidoEmissao` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NuvemFiscalClient::NfcomPedidoEmissao`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'inf_nf_com')
        self.inf_nf_com = attributes[:'inf_nf_com']
      else
        self.inf_nf_com = nil
      end
    ...
    def list_invalid_properties
      ...
      if @inf_nf_com.nil?
        invalid_properties.push('invalid value for "inf_nf_com", inf_nf_com cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @inf_nf_com.nil?
    ...
    # @param [Object] inf_nf_com Value to be assigned
    def inf_nf_com=(inf_nf_com)
      if inf_nf_com.nil?
        fail ArgumentError, 'inf_nf_com cannot be nil'
      end

      @inf_nf_com = inf_nf_com
    end
    ...
    def hash
      [inf_nf_com, ambiente, referencia].hash
    end
