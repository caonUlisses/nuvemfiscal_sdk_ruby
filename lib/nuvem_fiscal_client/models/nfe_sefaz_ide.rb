...
module NuvemFiscalClient
  ...
  class NfeSefazIde
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'d_prev_entrega')
        self.d_prev_entrega = attributes[:'d_prev_entrega']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          d_prev_entrega == o.d_prev_entrega &&
          tp_nf == o.tp_nf &&
          id_dest == o.id_dest &&
          c_mun_fg == o.c_mun_fg &&
    ...
    def hash
      [c_uf, c_nf, nat_op, mod, serie, n_nf, dh_emi, dh_sai_ent, d_prev_entrega, tp_nf, id_dest, c_mun_fg, c_mun_fgibs, tp_imp, tp_emis, c_dv, tp_amb, fin_nfe, tp_nf_debito, tp_nf_credito, ind_final, ind_pres, ind_intermed, proc_emi, ver_proc, dh_cont, x_just, n_fref, g_compra_gov, g_pag_antecipado].hash
    end
