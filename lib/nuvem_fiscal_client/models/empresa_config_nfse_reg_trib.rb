...
module NuvemFiscalClient
  ...
  class EmpresaConfigNfseRegTrib
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NuvemFiscalClient::EmpresaConfigNfseRegTrib` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NuvemFiscalClient::EmpresaConfigNfseRegTrib`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'op_simp_nac')
        self.op_simp_nac = attributes[:'op_simp_nac']
      end

      if attributes.key?(:'reg_ap_trib_sn')
        self.reg_ap_trib_sn = attributes[:'reg_ap_trib_sn']
      end

      if attributes.key?(:'reg_esp_trib')
        self.reg_esp_trib = attributes[:'reg_esp_trib']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          op_simp_nac == o.op_simp_nac &&
          reg_ap_trib_sn == o.reg_ap_trib_sn &&
          reg_esp_trib == o.reg_esp_trib
    end
    ...
    def hash
      [op_simp_nac, reg_ap_trib_sn, reg_esp_trib].hash
    end
