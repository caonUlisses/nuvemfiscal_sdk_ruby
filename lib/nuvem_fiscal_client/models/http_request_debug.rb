...
module NuvemFiscalClient
  ...
  class HttpRequestDebug
    ...
    attr_accessor :response_status_reason
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NuvemFiscalClient::HttpRequestDebug` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NuvemFiscalClient::HttpRequestDebug`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'response_status_reason')
        self.response_status_reason = attributes[:'response_status_reason']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          response_status_reason == o.response_status_reason &&
    ...
    def hash
      [id, method, uri, headers, response_status_code, response_status_reason, response_headers, response_time].hash
    end
