...
module NuvemFiscalClient
  ...
  class NfeSefazProd
    ...
    def hash
      [c_prod, c_ean, c_barra, x_prod, ncm, nve, cest, ind_escala, cnpj_fab, c_benef, g_cred, extipi, cfop, u_com, q_com, v_un_com, v_prod, c_ean_trib, c_barra_trib, u_trib, q_trib, v_un_trib, v_frete, v_seg, v_desc, v_outro, ind_tot, ind_bem_movel_usado, di, det_export, x_ped, n_item_ped, n_fci, rastro, inf_prod_nff, inf_prod_emb, veic_prod, med, arma, comb, n_recopi].hash
    end
