  ...
  class CteSefazToma4
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NuvemFiscalClient::CteSefazToma4` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NuvemFiscalClient::CteSefazToma4`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'ender_toma')
        self.ender_toma = attributes[:'ender_toma']
      else
        self.ender_toma = nil
      end
    ...
    def list_invalid_properties
      ...
      if !@x_fant.nil? && @x_fant.to_s.length < 2
        invalid_properties.push('invalid value for "x_fant", the character length must be greater than or equal to 2.')
      end

      if @ender_toma.nil?
        invalid_properties.push('invalid value for "ender_toma", ender_toma cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @ender_toma.nil?
    ...
    def x_fant=(x_fant)
      ...
      if !x_fant.nil? && x_fant.to_s.length < 2
        fail ArgumentError, 'invalid value for "x_fant", the character length must be greater than or equal to 2.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] ender_toma Value to be assigned
    def ender_toma=(ender_toma)
      if ender_toma.nil?
        fail ArgumentError, 'ender_toma cannot be nil'
      end

      @ender_toma = ender_toma
    end
    ...
    def hash
      [toma, cnpj, cpf, ie, x_nome, x_fant, fone, ender_toma, email].hash
    end
