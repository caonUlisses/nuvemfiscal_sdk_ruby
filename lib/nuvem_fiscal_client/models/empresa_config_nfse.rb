...
module NuvemFiscalClient
  class EmpresaConfigNfse
    attr_accessor :reg_trib

    attr_accessor :rps

    attr_accessor :prefeitura
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NuvemFiscalClient::EmpresaConfigNfse` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NuvemFiscalClient::EmpresaConfigNfse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'reg_trib')
        self.reg_trib = attributes[:'reg_trib']
      end
      ...
      if attributes.key?(:'prefeitura')
        self.prefeitura = attributes[:'prefeitura']
      end

      if attributes.key?(:'incentivo_fiscal')
        self.incentivo_fiscal = attributes[:'incentivo_fiscal']
      else
        self.incentivo_fiscal = false
      end
    ...
    def list_invalid_properties
      ...
      if @rps.nil?
        invalid_properties.push('invalid value for "rps", rps cannot be nil.')
      end
    ...
    # @param [Object] rps Value to be assigned
    def rps=(rps)
      if rps.nil?
        fail ArgumentError, 'rps cannot be nil'
      end
    ...
    def hash
      [reg_trib, rps, prefeitura, incentivo_fiscal, ambiente].hash
    end
