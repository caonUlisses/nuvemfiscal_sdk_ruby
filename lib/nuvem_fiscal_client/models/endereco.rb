  ...
  class Endereco
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NuvemFiscalClient::Endereco` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NuvemFiscalClient::Endereco`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'end_nac')
        self.end_nac = attributes[:'end_nac']
      end
      ...
      if attributes.key?(:'tp_lgr')
        self.tp_lgr = attributes[:'tp_lgr']
      end
    ...
    def list_invalid_properties
      ...
      if !@x_lgr.nil? && @x_lgr.to_s.length < 1
        invalid_properties.push('invalid value for "x_lgr", the character length must be greater than or equal to 1.')
      end
      ...
      if !@x_bairro.nil? && @x_bairro.to_s.length < 1
        invalid_properties.push('invalid value for "x_bairro", the character length must be greater than or equal to 1.')
      end
    ...
    def valid?
      ...
      return false if !@x_lgr.nil? && @x_lgr.to_s.length > 255
      return false if !@x_lgr.nil? && @x_lgr.to_s.length < 1
      ...
      return false if !@x_bairro.nil? && @x_bairro.to_s.length < 1
      true
    end
    ...
    def x_lgr=(x_lgr)
      ...
      if !x_lgr.nil? && x_lgr.to_s.length < 1
        fail ArgumentError, 'invalid value for "x_lgr", the character length must be greater than or equal to 1.'
      end
    ...
    def x_bairro=(x_bairro)
      ...
      if !x_bairro.nil? && x_bairro.to_s.length < 1
        fail ArgumentError, 'invalid value for "x_bairro", the character length must be greater than or equal to 1.'
      end
    ...
    def hash
      [end_nac, end_ext, x_lgr, tp_lgr, nro, x_cpl, x_bairro].hash
    end
