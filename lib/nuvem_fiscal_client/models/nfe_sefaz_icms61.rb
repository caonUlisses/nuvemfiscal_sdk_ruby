  ...
  class NfeSefazICMS61
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NuvemFiscalClient::NfeSefazICMS61` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NuvemFiscalClient::NfeSefazICMS61`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'ad_rem_icms_ret')
        self.ad_rem_icms_ret = attributes[:'ad_rem_icms_ret']
      else
        self.ad_rem_icms_ret = nil
      end

      if attributes.key?(:'v_icms_mono_ret')
        self.v_icms_mono_ret = attributes[:'v_icms_mono_ret']
      else
        self.v_icms_mono_ret = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @ad_rem_icms_ret < 0
        invalid_properties.push('invalid value for "ad_rem_icms_ret", must be greater than or equal to 0.')
      end

      if @v_icms_mono_ret < 0
    ...
    def valid?
      ...
      return false if @ad_rem_icms_ret < 0
      return false if @v_icms_mono_ret < 0
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] ad_rem_icms_ret Value to be assigned
    def ad_rem_icms_ret=(ad_rem_icms_ret)
      if !ad_rem_icms_ret.nil? && ad_rem_icms_ret < 0
        fail ArgumentError, 'invalid value for "ad_rem_icms_ret", must be greater than or equal to 0.'
      end

      @ad_rem_icms_ret = ad_rem_icms_ret
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ad_rem_icms_ret == o.ad_rem_icms_ret &&
    ...
    def hash
      [orig, cst, q_bc_mono_ret, ad_rem_icms_ret, v_icms_mono_ret].hash
    end
