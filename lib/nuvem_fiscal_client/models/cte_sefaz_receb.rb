  ...
  class CteSefazReceb
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NuvemFiscalClient::CteSefazReceb` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NuvemFiscalClient::CteSefazReceb`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'ender_receb')
        self.ender_receb = attributes[:'ender_receb']
      else
        self.ender_receb = nil
      end
    ...
    def list_invalid_properties
      ...
      if @ender_receb.nil?
        invalid_properties.push('invalid value for "ender_receb", ender_receb cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @ender_receb.nil?
    ...
    # Custom attribute writer method with validation
    # @param [Object] ender_receb Value to be assigned
    def ender_receb=(ender_receb)
      if ender_receb.nil?
        fail ArgumentError, 'ender_receb cannot be nil'
      end

      @ender_receb = ender_receb
    end
    ...
    def hash
      [cnpj, cpf, ie, x_nome, fone, ender_receb, email].hash
    end
