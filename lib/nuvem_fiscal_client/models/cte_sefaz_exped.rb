  ...
  class CteSefazExped
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NuvemFiscalClient::CteSefazExped` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NuvemFiscalClient::CteSefazExped`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'ender_exped')
        self.ender_exped = attributes[:'ender_exped']
      else
        self.ender_exped = nil
      end
    ...
    def list_invalid_properties
      ...
      if @ender_exped.nil?
        invalid_properties.push('invalid value for "ender_exped", ender_exped cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @ender_exped.nil?
    ...
    # Custom attribute writer method with validation
    # @param [Object] ender_exped Value to be assigned
    def ender_exped=(ender_exped)
      if ender_exped.nil?
        fail ArgumentError, 'ender_exped cannot be nil'
      end

      @ender_exped = ender_exped
    end
    ...
    def hash
      [cnpj, cpf, ie, x_nome, fone, ender_exped, email].hash
    end
