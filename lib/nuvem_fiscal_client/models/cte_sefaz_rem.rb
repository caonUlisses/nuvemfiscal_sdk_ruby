  ...
  class CteSefazRem
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NuvemFiscalClient::CteSefazRem` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NuvemFiscalClient::CteSefazRem`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'ender_reme')
        self.ender_reme = attributes[:'ender_reme']
      else
        self.ender_reme = nil
      end
    ...
    def list_invalid_properties
      ...
      if @ender_reme.nil?
        invalid_properties.push('invalid value for "ender_reme", ender_reme cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @ender_reme.nil?
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] ender_reme Value to be assigned
    def ender_reme=(ender_reme)
      if ender_reme.nil?
        fail ArgumentError, 'ender_reme cannot be nil'
      end

      @ender_reme = ender_reme
    end
    ...
    def hash
      [cnpj, cpf, ie, x_nome, x_fant, fone, ender_reme, email].hash
    end
