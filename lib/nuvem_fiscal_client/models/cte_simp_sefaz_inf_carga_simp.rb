...
module NuvemFiscalClient
  ...
  class CteSimpSefazInfCargaSimp
    ...
    def self.openapi_types
      {
        ...
        :'pro_pred' => :'String',
        :'x_out_cat' => :'String',
        :'inf_q' => :'Array<CteSimpSefazInfQSimp>',
        :'v_carga_averb' => :'Float'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NuvemFiscalClient::CteSimpSefazInfCargaSimp` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NuvemFiscalClient::CteSimpSefazInfCargaSimp`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
