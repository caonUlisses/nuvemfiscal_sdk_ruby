# NuvemFiscalClient::CteOsCartaCorrecao

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **correcoes** | [**Array&lt;CteOsInfCorrecao&gt;**](CteOsInfCorrecao.md) | Grupo de Informações de Correção. |  |
...
instance = NuvemFiscalClient::CteOsCartaCorrecao.new(
  correcoes: null,
  id: null,
  ambiente: null,
  status: null,
