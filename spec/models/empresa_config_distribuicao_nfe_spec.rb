...
# Unit tests for NuvemFiscalClient::EmpresaConfigDistribuicaoNfe
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe NuvemFiscalClient::EmpresaConfigDistribuicaoNfe do
  let(:instance) { NuvemFiscalClient::EmpresaConfigDistribuicaoNfe.new }
  ...
  describe 'test an instance of EmpresaConfigDistribuicaoNfe' do
    it 'should create an instance of EmpresaConfigDistribuicaoNfe' do
      ...
      #expect(instance).to be_instance_of(NuvemFiscalClient::EmpresaConfigDistribuicaoNfe)
    end
  end
  ...
  describe 'test attribute "distribuicao_intervalo_horas"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
