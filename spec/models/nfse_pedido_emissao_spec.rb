...
# Unit tests for NuvemFiscalClient::NfsePedidoEmissao
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe NuvemFiscalClient::NfsePedidoEmissao do
  let(:instance) { NuvemFiscalClient::NfsePedidoEmissao.new }

  describe 'test an instance of NfsePedidoEmissao' do
    it 'should create an instance of NfsePedidoEmissao' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(NuvemFiscalClient::NfsePedidoEmissao)
    end
  end
